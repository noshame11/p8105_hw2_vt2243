...
brfss_data %>%
  filter(locationdesc %in% c("New York County", "Queens Count"), year %in% c("2002":"2012")) %>% ggplot(aes(x = year, y = excellent, color = locationdesc)) + geom_point() + scale_x_continuous(breaks = c(2002:2010))
```